...
function wmat = ptwgc_lat_fortest(fname,lat1,M,N,refa,dec,HA,HAstart,step,HAend)
...
%dlmwrite('myphasetermfile.txt',wmat,'delimiter',' ','precision','%6.5f')  
%else
%dlmwrite('myphasetermfile.txt',wmat,'-append',...
